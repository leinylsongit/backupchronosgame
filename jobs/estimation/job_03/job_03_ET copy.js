...
//         var hand = BABYLON.MeshBuilder.CreatePlane("hand", {width: 2, height: 2}, scene);
//         var handMaterial = new BABYLON.StandardMaterial("handMaterial", scene);
//         handMaterial.diffuseTexture = new BABYLON.Texture("../../../assets/gui/hand2.png", scene);
//         hand.material = handMaterial;
        
//         // Configure the interaction with the hand image:
//         var handPointer = new BABYLON.DefaultCursor("handPointer", scene);
...
//         hand.cursor = handPointer;
  ...
  //
  BABYLON.SceneLoader.ImportMesh(null, 'model/', 'floresta_perene.glb', scene, (meshes) => {
    // 3D assets are loaded, now load nav mesh
    var ambiente = meshes[0];
    ambiente.scaling = new BABYLON.Vector3(120, 120, 120);
    ambiente.position = new BABYLON.Vector3(-10, -5, 0);
