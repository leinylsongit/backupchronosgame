...
function init() {
  ...
  //
  BABYLON.SceneLoader.ImportMesh(null, 'model/', 'Labirinto_cerebro.glb', scene, (meshes) => {
    // 3D assets are loaded, now load nav mesh

    var ambiente = meshes[0];
    ambiente.scaling = new BABYLON.Vector3(2, 2, 2);
    ambiente.position = new BABYLON.Vector3(-2, -3, 0);
