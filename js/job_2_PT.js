...
var create_Tarefa = function () {
    ...
    gl.isEnabled = false;
     ...
     var material = new BABYLON.StandardMaterial("kosh", job_2PT);
  var sphere1 = BABYLON.Mesh.CreateSphere("Sphere1", 32, 3, job_2PT);
  var sphere2 = BABYLON.Mesh.CreateSphere("Sphere2", 32, 3, job_2PT);
  var sphere3 = BABYLON.Mesh.CreateSphere("Sphere3", 32, 3, job_2PT);
  var sphere4 = BABYLON.Mesh.CreateSphere("Sphere4", 32, 3, job_2PT);
  var sphere5 = BABYLON.Mesh.CreateSphere("Sphere5", 32, 3, job_2PT);
//   var light = new BABYLON.PointLight("Omni0", new BABYLON.Vector3(-17.6, 18.8, -49.9), job_2PT);
...
//   camera.attachControl(canvas, true);
  ...
  // Sphere1 material
  material.reflectionTexture = new BABYLON.CubeTexture("assets/skybox/TropicalSunnyDay", job_2PT);
  ...
  // Sphere2 material
  material = new BABYLON.StandardMaterial("kosh2", job_2PT);
  material.reflectionTexture = new BABYLON.CubeTexture("assets/skybox/TropicalSunnyDay", job_2PT);
  material.diffuseColor = new BABYLON.Color3(0, 0, 0);
  material.emissiveColor = new BABYLON.Color3(0.5, 0.5, 0.5);
  ...
  // Sphere3 material
  material = new BABYLON.StandardMaterial("kosh3", job_2PT);
  material.diffuseColor = new BABYLON.Color3(0, 0, 0);
  ...
  // Sphere4 material
  material = new BABYLON.StandardMaterial("kosh4", job_2PT);
  material.diffuseColor = new BABYLON.Color3(0, 0, 0);
  material.emissiveColor = BABYLON.Color3.White();
  material.specularPower = 64;
  ...
  // Sphere5 material
  material = new BABYLON.StandardMaterial("kosh5", job_2PT);
  material.diffuseColor = new BABYLON.Color3(0, 0, 0);
  material.reflectionTexture = new BABYLON.CubeTexture("assets/skybox/TropicalSunnyDay", job_2PT);
...
//   // Skybox
  var skybox = BABYLON.Mesh.CreateBox("skyBox", 100.0, job_2PT);
  var skyboxMaterial = new BABYLON.StandardMaterial("skyBox", job_2PT);
  skyboxMaterial.backFaceCulling = false;
  skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("assets/skybox/TropicalSunnyDay", job_2PT);
